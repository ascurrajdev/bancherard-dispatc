...
public class StringUtils {
	...
	private static final JSONTransformer<String> stringTransformer = new JSONTransformer<String>(String.class);
	private static final JSONTransformer<String[]> stringArrayTransformer = new JSONTransformer<String[]>(String[].class);

	public static final String BILLS_NO_DATA_FOUND = "No se pudo obtener el registro Bills";
	public static final String PLAN_NO_DATA_FOUND = "No se pudo obtener la Lista de Plan";
	public static final String CONTACT_NO_DATA_FOUND = "No se pudo obtener la Lista de Contactos";
	
	
	public static final String MSG_DISPATCHER_BODY_HEADER = "Dispatcher Host: ";
	public static final String MSG_SUMMARY = "### SUMMARY ###";
	public static final String MSG_MS_SUCCESSFULLY = "MS Successfully: ";
	public static final String MSG_MS_ERROR = "MS errors: ";
	...
	public static String listStringToJson(List<String> list) throws BancardAPIException{
		return (list == null || list.isEmpty()) ? null : stringTransformer.fromList(list);
	}

	public static List<String> jSonlistToStringList(String json) throws BancardAPIException{
		return (json == null || json.isEmpty() || "".equals(json)) ? null : stringTransformer.toList(json);
	}

	public static String stringArrayToJson(String[] array) throws BancardAPIException{
		return (array == null || array.length == 0) ? null : stringArrayTransformer.toJSON(array);
	}

	public static String[] jSonlistToStringArray(String json) throws BancardAPIException{
		return (json == null || json.isEmpty() || "".equals(json)) ? null : stringArrayTransformer.fromJSON(json);
	}
	...
	public static List<String> toListByStringWithCommaSeparator(String str){
